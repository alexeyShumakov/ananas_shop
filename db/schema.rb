...
ActiveRecord::Schema.define(version: 20160819114602) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.integer  "orders_status_id"
  end

  add_index "orders", ["address_id"], name: "index_orders_on_address_id", using: :btree
  add_index "orders", ["orders_status_id"], name: "index_orders_on_orders_status_id", using: :btree
